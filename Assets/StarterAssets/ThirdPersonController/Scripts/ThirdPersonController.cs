...
public GameObject StarterButton;
    ...
    // Check if the child has the "MainCamera" tag
    if (child.CompareTag("MainCamera") && !cameraChanged) {
        // You've found the "MainCamera" in the children of the parent
        _mainCamera = child.gameObject;
        cameraChanged = true;
        ...
        break; // You can break the loop if you found the camera
    }
